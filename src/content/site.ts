...
export const site = {
  ...
  url: "https://oberon.kz",
  description:
    "Системный интегратор в Казахстане: телекоммуникации, информационная безопасность, вычислительные системы и сервисное сопровождение.",
  ...
  sales: {
    name: "Богославский Максим",
    role: "Менеджер по продажам и развитию бизнеса",
    phone: { label: "+7 (708) 313-22-79", href: "tel:+77083132279" },
  },
