        ...
        <div className="relative px-6 py-20 sm:px-12 lg:px-20 lg:py-32">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-white/80">
              ТОО «ОБЕРОН Групп» работает на ИТ-рынке Казахстана с 2015 года: телекоммуникации, информационная
              безопасность, вычислительные системы и сервисное сопровождение — в одной команде.
            </p>
